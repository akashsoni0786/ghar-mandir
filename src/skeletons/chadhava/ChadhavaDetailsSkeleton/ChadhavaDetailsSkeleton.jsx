...
import "./ChadhavaDetailsSkeleton.css";
import {
  SkeletonAvatar,
  SkeletonBox,
  SkeletonCard,
          ...
          <div className="container-box">
            ...
            <div className="package-selection-offering">
              {[1, 2, 3, 4, 5, 6, 7]?.map((item, index) => {
                return (
                  <div key={index} className="package-selection-offering--box">
                    <div style={{ width: "90%" }}>
                      <div style={{padding:"8px 0"}}><SkeletonLine width={"60%"} height={"20px"} /></div>
                      <SkeletonParagraph lines={2} lineHeight={"10px"} />
...
export default ChadhavaDetailsSkeleton;

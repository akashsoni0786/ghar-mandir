    ...
    <div className="date-temple-container">
      <div className="date-temple-cards ph-1">
        {devineExperience.map((card, index) => (
          <div key={index} className="date-temple-card">
            ...
            <div className="date-temple-card--content">
              <div className="date-temple-card--date">{card.date}</div>
              <div className="date-temple-card--temple-title">{card.title}</div>
            </div>
          </div>
        ))}
      </div>
      ...
      <div className="mobile-carousel">
        <div className="carousel-bubbles">
          ...
          {devineExperience.map((_: any, idx: number) => {
            if (idx > 1) {
              return <div key={idx} className="bubble"></div>;
            }
          })}
      ...
      {width < 480 && (
        <div className="date-temple-card--fw-content ph-1">
          <div className="date-temple-card--date">
            {devineExperience[activeIndex]?.date ?? ""}
          </div>
          <div className="date-temple-card--temple-title">
            {devineExperience[activeIndex]?.title ?? ""}
          </div>
        </div>
      )}
...
export default DivineExperience;

      ...
      <div className="date-temple-cards-booking ph-1">
        {devineExperience.map((card, index) => (
          <span key={index}>
            ...
            <div className="date-temple-card--actions">
              <div className="date-temple-card--download">
                <span>
                  <Download className="text-icon" size={16} />{" "}
                </span>
                <span className="text-icon">Download</span>
              </div>
              <div className="date-temple-card--share">
                <span>
                  <WhatsappColoredIcon className="icon-width" />{" "}
                </span>
